...
class Uninstall extends Process
{
    ...
    public static function process(): bool
    {
        ...
        // Database table name
        // $table = dcCore::app()->prefix . 'auberge';
        ...
        $user_actions = [
            ...
            // Field (database)
            'fields' => [
                ['delete', 'user:room_id'],     // Delete field
                ['delete', 'user:staff_role'],  // Delete field
                ['delete', 'user:check_in'],    // Delete field
                ['delete', 'user:check_out'],   // Delete field
                ['delete', 'user:stays'],       // Delete field
            ],
